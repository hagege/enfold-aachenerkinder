...
<h4>Uupps - nichts gefunden</h4>
<?php _e('Sorry, the post you are looking for is not available. Maybe you want to perform a search?', 'avia_framework'); ?>
</p>
<p>Wahrscheinlich handelt es sich um einen älteren Eintrag (Veranstaltung oder Beitrag), den wir auf aachenerkinder.de bereits gelöscht haben.<br>
Möglicherweise gibt es aber auch ähnliche Veranstaltungen oder Beiträge, die aktuell sind. <br>
<strong>Daher schlagen wir euch vor, in das folgende Suchfeld entsprechende Begriffe einzugeben.</strong>
</p>
<?php
